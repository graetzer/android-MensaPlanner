 ...
 * lead to a {@link MensaDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link MensaListFragment} and the item details
 * (if present) is a {@link MensaDetailFragment}.
 * <p/>
...
public class MensaListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.mensa_detail_container) != null) {
    ...
    /**
     * Callback method from {@link MensaListFragment.Callbacks}
